...
public class AnalyticsStreamConsumer implements StreamListener<String, MapRecord<String, String, ClickEvent>> {

    private final AnalyticsService analyticsService;
    private final LinkRepository linkRepository;

    @Override
    public void onMessage(MapRecord<String, String, ClickEvent> message) {
        try {
            ClickEvent event = message.getValue().get("event");
            if (event != null) {
